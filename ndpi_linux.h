...
extern struct ndpi_detection_module_struct *ndpi_struct_initialize(NDPI_PROTOCOL_BITMASK *);
extern void ndpi_struct_exit(struct ndpi_detection_module_struct *);
extern ndpi_proto_defaults_t *ndpi_get_proto_defaults_wrapper(struct ndpi_detection_module_struct *, bool *, bool *);
